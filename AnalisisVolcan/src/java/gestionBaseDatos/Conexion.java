...
public class Conexion {
	...
	private String msg;
     ...
     try {
        ...
        this.con = DriverManager.getConnection ("jdbc:mysql://localhost:3306/analisis_volcan","root","1234");
    ...
    public ResultSet select(String campos, String tabla, String prefijo,
