...
public class ProductoDAO {
	...
	public static Producto loadProductoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Producto) session.load(orm.Producto.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Producto getProductoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Producto) session.get(orm.Producto.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Producto loadProductoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Producto) session.load(orm.Producto.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Producto getProductoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Producto) session.get(orm.Producto.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryProducto(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From orm.Producto as Producto");
		if (condition != null)
	...
	public static Producto createProducto() {
		return new orm.Producto();
	}
	
	public static boolean save(orm.Producto producto) throws PersistentException {
		try {
			orm.LjPersistentManager.instance().saveObject(producto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Producto producto) throws PersistentException {
		try {
			orm.LjPersistentManager.instance().deleteObject(producto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Producto producto)throws PersistentException {
		try {
			if(producto.getCategoria() != null) {
				producto.getCategoria().producto.remove(producto);
			}
			
			if(producto.getProveedor() != null) {
				producto.getProveedor().producto.remove(producto);
			}
			
			orm.Producto_compra[] lProducto_compras = producto.producto_compra.toArray();
			for(int i = 0; i < lProducto_compras.length; i++) {
				lProducto_compras[i].setProducto(null);
			}
	...
	public static boolean deleteAndDissociate(orm.Producto producto, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(producto.getCategoria() != null) {
				producto.getCategoria().producto.remove(producto);
			}
	...
	public static boolean refresh(orm.Producto producto) throws PersistentException {
		try {
			orm.LjPersistentManager.instance().getSession().refresh(producto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Producto producto) throws PersistentException {
		try {
			orm.LjPersistentManager.instance().getSession().evict(producto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
